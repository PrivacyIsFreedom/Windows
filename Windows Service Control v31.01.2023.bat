@echo off
title Windows Service Control v31.01.2023
color 30
echo.
echo.
:start
...
echo File Version: 31.01.2023 - Press X and hit ENTER to get the latest Version.
echo.
...
echo.
echo.
echo Unnecessary Services: (Total 93)
echo.
echo.
