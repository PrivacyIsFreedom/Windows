@echo off
title Windows Service Control v02.11.2022
color 30
echo.
echo.
:start
...
echo File Version: 02.11.2022 - Press X and hit ENTER to get the latest Version.
echo.
echo Press 1 to view my Youtube Channel.
echo Press 2 to view my Youtube Channel without Tracking.
echo.
echo Press A and hit ENTER to view a list of all services and tasks.
echo.
echo Press B and hit ENTER to disable    unnecessary services and tasks.
echo Press C and hit ENTER to reactivate unnecessary services and tasks.
echo.
echo Press D and hit ENTER to disable    windows update and store services and tasks.
echo Press E and hit ENTER to reactivate windows update and store services and tasks.
echo.
echo Press F and hit ENTER to disable    remote services and tasks.
echo Press G and hit ENTER to reactivate remote services and tasks.
echo.
echo Press H and hit ENTER to disable    printer services and tasks.
echo Press I and hit ENTER to reactivate printer services and tasks.
echo.
echo Press J and hit ENTER to disable    bluetooth services and tasks.
echo Press K and hit ENTER to reactivate bluetooth services and tasks.
echo.
echo Press L and hit ENTER to disable    wifi services and tasks.
echo Press M and hit ENTER to reactivate wifi services and tasks.
echo.
...
echo.
@echo off
echo Total amount of unnecessary services to be disabled = 92.
...
echo.
echo.
echo Unnecessary Services: (Total 92)
echo.
echo.
...
echo.
echo.
echo Update and Store Services: (Total 12)
echo.
echo.
echo DoSvc
echo upfc
...
pause
:1
start https://www.youtube.com/channel/UCb5DJKYvC4fzjzv7oQbmFRA
goto start
pause
:2
...
pause
:X
start https://github.com/Windows-Management/Windows-Management
goto start
pause
:R
:r
